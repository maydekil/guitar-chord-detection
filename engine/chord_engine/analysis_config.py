...
ALGORITHM_ID = "chroma-template-v47"
...
PLAYABLE_MULTI_SECTION_PATTERN_MIN_SONG_SECONDS = 150.0
PLAYABLE_MULTI_SECTION_PATTERN_MIN_START_SECONDS = 72.0
PLAYABLE_MULTI_SECTION_PATTERN_MIN_WINDOW_SECONDS = 22.0
PLAYABLE_MULTI_SECTION_PATTERN_MAX_WINDOW_SECONDS = 96.0
PLAYABLE_MULTI_SECTION_PATTERN_MAX_START_SECONDS = 265.0
PLAYABLE_MULTI_SECTION_PATTERN_MIN_EVIDENCE = 0.48
PLAYABLE_MULTI_SECTION_PATTERN_MIN_CHROMA_EVIDENCE = 0.57
PLAYABLE_MULTI_SECTION_PATTERN_MIN_SCORE = 0.48
PLAYABLE_MULTI_SECTION_PATTERN_MIN_GAIN = 0.03
PLAYABLE_MULTI_SECTION_PATTERN_MIN_SUPPORT = 0.70
PLAYABLE_MULTI_SECTION_PATTERN_MAX_BOUNDARY_OFFSET = 0.80
PLAYABLE_MULTI_SECTION_PATTERN_MIN_SLOT_SECONDS = 2.0
PLAYABLE_MULTI_SECTION_PATTERN_MAX_SLOT_SECONDS = 6.0
PLAYABLE_MULTI_SECTION_PATTERN_SLOT_STEP_SECONDS = 0.2
PLAYABLE_MULTI_SECTION_PATTERN_MAX_CANDIDATES = 6
PLAYABLE_MULTI_SECTION_PATTERN_CONFIDENCE = 0.88

PLAYABLE_DSP_MULTI_SECTION_MIN_EVIDENCE = 0.42
PLAYABLE_DSP_MULTI_SECTION_MIN_GAIN = 0.00
PLAYABLE_DSP_MULTI_SECTION_MIN_SUPPORT = 0.62
PLAYABLE_DSP_MULTI_SECTION_MAX_CANDIDATES = 8
