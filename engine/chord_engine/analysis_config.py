...
ALGORITHM_ID = "chroma-template-v12"
...
PLAYABLE_PROGRESSION_FRAGMENT_SECONDS = 1.20
PLAYABLE_PROGRESSION_WEAK_CONFIDENCE = 0.46
PLAYABLE_PROGRESSION_SHORT_NON_DIATONIC_SECONDS = 2.20
PLAYABLE_PROGRESSION_SHORT_DIATONIC_SECONDS = 0.85
