...
export function selectPlayableChordSegments(analysis: ChordAnalysisSuccess): ChordSegment[] {
    if (analysis.analysis.leadSheetSource === "lyrics" && analysis.analysis.detectedChords) {
        return analysis.analysis.detectedChords;
    }
...
export function buildLeadSheetAnalysis(
    ...
    const chords = buildLeadSheetTimelineFromSegments(sourceChords, analysis.source.duration);
    return {
        ...analysis,
        analysis: {
            ...analysis.analysis,
